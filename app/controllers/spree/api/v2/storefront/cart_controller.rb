    ...
    module V2
      module Storefront
        class CartController < ::Spree::Api::V2::BaseController
          ...
          # Add spree product subscription
          before_action :add_subscription_fields, only: :add_item, if: -> { params[:options][:frequency_id].present? }
          ...
          def add_subscription_fields
            ...
            p "existing_options: #{existing_options}"
            ...
            p "updated_subscription_params: #{updated_subscription_params.inspect}"
            existing_options[:options].merge!(updated_subscription_params)
            updated_params = params.merge!(existing_options)
            p "updated_params: #{updated_params.inspect}"
            updated_params
          end
